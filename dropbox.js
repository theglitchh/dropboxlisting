...
function displayFiles(files, currentPath) {
    ...
    if (files.length === 0) {
        ...
        fileTable.append(`<tr align="center" style="background-color:#f79a61;font-family: -apple-system, system-ui, system-ui, Helvetica, Arial, sans-serif;"><th>S.No</th><th>${currentPath === '' ? 'Project Folder' : currentPath.split('/').pop()}</th><th>Type</th><th>Open Folders</th></tr>`);
        ...
        files.forEach((file, index) => {
            ...
            var fileRow = $('<tr></tr>').css('background-color', index % 2 === 0 ? 'white' : '#fce2d2'); // Apply alternating background colors;
            ...
            var openFoldersCell = $('<td align="center"></td>'); // Create a cell for the "Open Folders" button
            if (fileType === 'folder') {
